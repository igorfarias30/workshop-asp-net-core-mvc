...
namespace SalesWebMvc.Data
{
    ...
    {
        public (Department[] departments, Seller[] sellers, SalesRecord[] sales) GetSeedData()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1.Id);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2.Id);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1.Id);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4.Id);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3.Id);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2.Id);
            ...
            return (
                departments: new[] { d1, d2, d3, d4 },
                sellers: new[] { s1, s2, s3, s4, s5, s6 },
                sales: new[] {r1, r2, r3, r4, r5, r6, r7, r8, r9, r10,
